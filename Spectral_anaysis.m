...
for i = 1:num_active
    ...
    ylim([1, 100]);
    ([-60, 0]); % Adjust color limits as needed
end

%% SOLUTION 1: Interactive Condition Selection for Individual Trial Spectrograms
...
%% SOLUTION 3: Interactive Condition Selection for Individual Trial Scalograms
...
for trial = 1:num_trials_wav
    ...
    imagesc(wavelet_condition_results.time_vec, wavelet_condition_results.frequencies, ...
        10*log10(wavelet_condition_results.scalograms(:, :, trial)));
    axis xy;
    colorbar;
    colormap('jet');
